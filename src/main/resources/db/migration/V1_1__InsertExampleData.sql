...
VALUES
    ...
    ('Una frase', 'Mauris aliquam efficitur neque et tincidunt. Duis sodales massa vel risus luctus tempus. Integer mattis erat vitae ultrices tincidunt.', NOW(), NOW(), 2, true),
    ('Cuando sería la entrga del proyecto', 'Mauris aliquam efficitur neque et tincidunt. Duis sodales massa vel risus luctus tempus. Integer mattis erat vitae ultrices tincidunt.', NOW(), NOW(), 2, true),
    ...
    ('Otra frase', 'Donec vel est sollicitudin, molestie nunc non, tincidunt velit. Integer convallis lacinia massa, eu vestibulum purus cursus ac.', NOW(), NOW(), 2, true);
